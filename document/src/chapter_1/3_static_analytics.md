...
2) Определить правила чтения синтаксического дерева выбранного исходного кода.
...
При определении структуры абстрактной модели представления определяются
основные атрибуты сущности, подходящие под описание целевой модели. При этом
целевая модель должна полностью отражать описываемую сущность и позволять
решать поставленные перед ней задачи. Если задачи требуют разные 
свойства одной сущности, стоит рассмотреть создание нескольких
абстрактных моделей для разделения групп задач на каждую из абстракций. 

При чтении синтаксического дерева исходного кода необходимо определить 
те элементы, которые необходимо учитывать при формировании абстрактной
